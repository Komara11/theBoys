...
function botStart(){
    init++
    if (init === 1){
        setTimeout(question.innerHTML = botSay()[1], 1200)
        answer.value = ""
    }else if(init === 2){
        setTimeout(question.innerHTML = botSay()[2], 1200)
        answer.value = ""
    }else if(init === 3){
        setTimeout(question.innerHTML = botSay()[3], 1200)
        answer.value = ""
    }else if(init === 4){
        setTimeout(question.innerHTML = botSay()[4], 1200)
        answer.value = ""
    }else{
        botEnd()
    }
